class PregnacyEvolutionsController < ApplicationController
	before_action :authenticate_doctor!
	before_action :set_gynecology_template
	before_action :set_pregnancy_evolution, only: [:show, :edit, :upate, :destroy]
	def new
	...
	private
		def pregnancy_evolution_parmas
			params.require(:pregnancy_evolution).permit(:day, :weeks_with_amenorrhea, :blood_pressure, :edema, :uterus_bottom, :fetal_hearbeat, :fetal_movements, :presentation, :pain, :genital_bleeding, :headache, :visual_hearing, :vomit, :urinales, :intestinal, :hb_htc, :glycemia, :albuminuria, :genital_exp, :treatment)
		end
